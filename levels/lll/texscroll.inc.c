void scroll_lll_dl_Level_002_mesh_layer_1_vtx_6() {
	int i = 0;
	int count = 14;
	int height = 32 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(lll_dl_Level_002_mesh_layer_1_vtx_6);
...
void scroll_lll_dl_Cylinder_002_mesh_layer_1_vtx_2() {
	int i = 0;
	int count = 58;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(lll_dl_Cylinder_002_mesh_layer_1_vtx_2);
...
void scroll_lll_dl_Plane_036_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 6;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(lll_dl_Plane_036_mesh_layer_1_vtx_0);
...
void scroll_lll() {
	scroll_lll_dl_Level_002_mesh_layer_1_vtx_6();
	...
	scroll_lll_dl_Cylinder_002_mesh_layer_1_vtx_2();
	scroll_lll_dl_Plane_036_mesh_layer_1_vtx_0();
};
