void scroll_lll_dl_Level_001_mesh_layer_1_vtx_7() {
	int i = 0;
	int count = 14;
	int height = 32 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(lll_dl_Level_001_mesh_layer_1_vtx_7);
...
void scroll_lll() {
	scroll_lll_dl_Level_001_mesh_layer_1_vtx_7();
