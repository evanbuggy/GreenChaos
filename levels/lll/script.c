...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_BULLY_LUIGI , -1825, 3411, -18551, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_LIFE_BOX, 4251, 4965, -16553, 0, 90, 0, (7 << 16) | (7), bhvExclamationBox),
		...
		OBJECT(MODEL_RING_BOX, -3309, 2766, -20085, 0, -90, 0, (6 << 24) | (6 << 16), bhvExclamationBox),
