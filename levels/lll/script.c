...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_GREEN_SPRING, -10966, -8578, 8122, 0, 0, 0, (0 << 24) | (10 << 16), bhvSpring),
		...
		OBJECT(MODEL_LIFE_BOX, 4251, 4965, -16553, 0, 90, 0, (8 << 8), bhvExclamationBox),
		...
		OBJECT(MODEL_RING_BOX, -3309, 2766, -20085, 0, -90, 0, (8 << 8), bhvExclamationBox),
