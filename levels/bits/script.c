...
const LevelScript level_bits_entry[] = {
	...
	AREA(1, bits_area_1),
		...
		OBJECT(MODEL_MR_L, 0, 1667, 2314, 0, 0, 0, 0x00000000, bhvBossLuigi),
		MARIO_POS(0x01, 180, 0, 1914, 3840),
		OBJECT(MODEL_NONE, 0, 1914, 3840, 0, 180, 0, 0x000A0000, bhvSpinAirborneWarp),
