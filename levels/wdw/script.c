...
const LevelScript level_wdw_entry[] = {
	...
	AREA(1, wdw_area_1),
		...
		OBJECT(MODEL_RED_COIN, -783, 1617, -8597, 0, 0, 0, (0 << 16), bhvRedCoin),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 8278, -690, 13033, 0, -180, 0, (51 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 4717, -341, 2959, 0, 180, 0, (54 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 10007, -2039, 7720, 0, 0, 0, (50 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_NONE, 0, 508, 5218, 0, 180, 0, 0x000A0000, bhvSpinAirborneWarp),
