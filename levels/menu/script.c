...
//        OBJECT(/*model*/ MODEL_TITLE_SCREEN_BG, /*pos*/ 0, -0, -10000, /*angle*/ 0, 0, 0, /*behParam*/ 0, /*beh*/ bhvTitleStaticObject),
    ...
    TRANSITION(/*transType*/ WARP_TRANSITION_FADE_FROM_COLOR, /*time*/ 70, /*color*/ 0xFF, 0xFF, 0xFF),
    ...
    TRANSITION(/*transType*/ WARP_TRANSITION_FADE_INTO_COLOR, /*time*/ 70, /*color*/ 0xFF, 0xFF, 0xFF),
    SLEEP(/*frames*/ 16),
    CLEAR_LEVEL(),
