...
void scroll_castle_grounds_dl_Cylinder_007_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 48;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_Cylinder_007_mesh_layer_1_vtx_0);
...
void scroll_castle_grounds_dl_Cylinder_008_mesh_layer_1_vtx_1() {
	int i = 0;
	int count = 48;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_Cylinder_008_mesh_layer_1_vtx_1);
...
void scroll_castle_grounds() {
	...
	scroll_castle_grounds_dl_Cylinder_007_mesh_layer_1_vtx_0();
	scroll_castle_grounds_dl_Cylinder_008_mesh_layer_1_vtx_1();
};
