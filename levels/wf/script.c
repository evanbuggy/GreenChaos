...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		MARIO_POS(0x01, 90, -64, 1250, 0),
		OBJECT(MODEL_GOOMBA, 4706, 491, -492, 0, 180, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 4813, 769, 3514, 0, 180, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 4706, 491, 364, 0, 180, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_NONE, -64, 1250, 0, 0, 90, 0, 0x000A0000, bhvSpinAirborneWarp),
