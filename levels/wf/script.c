...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 0, 1216, 0, 0, 0, 0, 0x00000000, bhvCoinFormation),
		...
		MARIO_POS(0x01, 180, 0, 130, 3419),
		OBJECT(MODEL_RED_COIN, 5877, 1484, -4803, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_YELLOW_COIN, 7768, 2014, -4803, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 12375, 2469, -4735, 0, 0, 0, 0x00000000, bhvOneCoin),
		...
		OBJECT(MODEL_YELLOW_COIN, 10219, 3193, -11359, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 9322, 3747, -9847, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 12375, 1469, -4735, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_GOOMBA, -492, 491, -4706, 0, -90, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 12375, 3316, -8436, 0, 25, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 364, 491, -4706, 0, -90, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 3262, 491, -4679, 0, -90, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 10991, 2808, -10834, 0, 25, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 9394, 3457, -10829, 0, 25, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, 10214, 4102, -9420, 0, -175, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_GOOMBA, -249, 4991, -14486, 0, 25, 0, 0x00000000, bhvCombatEnemy),
		OBJECT(MODEL_NONE, 0, 130, 3419, 0, 180, 0, 0x000A0000, bhvSpinAirborneWarp),
