...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -8679, 11961, 7431, 0, -55, 0, 0x00000000, bhvBulletBillCannon),
		...
		OBJECT(MODEL_ELECTRO_LUIGI, -6820, 12633, 2197, 0, 0, 0, 0x00000000, bhvElectroLuigi),
		...
		OBJECT(MODEL_WF_ROTATING_WOODEN_PLATFORM, -11424, 13056, 8450, 0, 90, 0, 0x00000000, bhvWfRotatingWoodenPlatform),
		...
		OBJECT(MODEL_WF_TUMBLING_BRIDGE, -9102, 13056, 8450, 0, 90, 0, 0x00000000, bhvWfTumblingBridge),
		OBJECT(MODEL_NONE, 0, 130, 3231, 0, 180, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_WHOMP, 12540, 2896, -8238, 0, 25, 0, 0x00000000, bhvSmallWhomp),
