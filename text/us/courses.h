...
COURSE_ACTS(COURSE_WF, _("   SPEED HIGHWAY"),
       _("GET TO THE GOAL RING!")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
       _("3 LUIGI RINGS"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))
...
COURSE_ACTS(COURSE_LLL, _("   LUIGI FACTORY"),
       _("GET TO THE GOAL RING!")            , _("BULLY THE BULLIES")             , _("3 LUIGI RINGS"),
