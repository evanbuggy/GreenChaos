...
COURSE_ACTS(COURSE_WF, _("   RADICAL FORTRESS"),
       _("DEFEAT KING WHOMP!")            , _("GET TO THE GOAL RING!")         , _("FIND THE 8 L RINGS!"),
       _("FREE PLAY")                     , _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))
...
COURSE_ACTS(COURSE_LLL, _("   LUIGI FACTORY"),
       _("DEFEAT BROOZER!")               , _("FIND THE 8 L RINGS!")           , _("FREE PLAY"),
...
COURSE_ACTS(COURSE_WDW, _("   TUTORIAL"),
       _("WELCOME!")                      , _("TOP O' THE TOWN")               , _("SECRETS IN THE SHALLOWS & SKY"),
...
SECRET_STAR(COURSE_BITS, _("   THE FINAL BATTLE"))
